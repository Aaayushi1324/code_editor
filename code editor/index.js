...
function share() {
    ...
    // Use the Clipboard API to copy the link to clipboard
    navigator.clipboard.writeText(shareLink)
        .then(() => {
            // Display an alert to indicate that the link is copied to clipboard
...
// Call the function to populate text areas when the page loads
